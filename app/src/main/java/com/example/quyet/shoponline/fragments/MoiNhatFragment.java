...
public class MoiNhatFragment extends Fragment implements RecyclerViewOnClickListenerHack, View.OnClickListener  {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.moi_nhat_layout, null);
    ...
    private void showProduct(){
        ...
        RecyclerView recyclerView = (RecyclerView) view.findViewById(R.id.moi_nhat_recycler_view);
        ...
        recyclerView.addOnItemTouchListener(new MoiNhatFragment.RecyclerViewTouchListener( getActivity(), recyclerView, this ));
    }
