...
public class PhoBienFragment extends Fragment implements RecyclerViewOnClickListenerHack, View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.pho_bien_layout, null);
    ...
    private void showProduct(){
        ...
        RecyclerView recyclerView = (RecyclerView) view.findViewById(R.id.pho_bien_recycler_view);
